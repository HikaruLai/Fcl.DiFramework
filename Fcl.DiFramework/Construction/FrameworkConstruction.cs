...
using LightInject;
using Fcl.DiFramework.Environment;

namespace Fcl.DiFramework.Construction
{
    /// <summary>
    /// The construction information when starting up and configuring project
    /// </summary>
    public class FrameworkConstruction
    {
        ...
        /// <summary>
        /// The lightInject dependency injection service container
        /// </summary>
